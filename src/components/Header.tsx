...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        >
          ...
          <span className="text-xl md:text-2xl font-bold tracking-tight text-slate-900 flex items-center">
            <span>Foundry</span>
            <span className="bg-gradient-to-r from-brand-primary to-brand-accent bg-clip-text text-transparent ml-0.5">
              4
            </span>
          </span>
        </a>
            ...
            return (
              <a
                ...
                className={`text-sm font-medium transition-colors duration-200 ${
                  isLinkActive ? "text-brand-primary" : "text-slate-600 hover:text-brand-primary"
                }`}
              >
                {link.name}
              </a>
        ...
        <div className="hidden md:block">
          <a
            ...
            className="inline-flex items-center justify-center px-5 py-2.5 rounded-full text-xs font-semibold tracking-wide uppercase transition-all duration-300 bg-brand-primary text-white hover:bg-brand-primary/90 hover:scale-[1.02] shadow-md shadow-blue-100 active:scale-[0.98]"
          >
            Start a Project
      ...
      <div
        id="mobile-menu"
        className={`md:hidden fixed inset-0 top-[64px] bg-white/98 backdrop-blur-xl transition-all duration-300 ease-in-out border-t border-slate-100 shadow-lg z-40 overflow-y-auto ${
          isOpen
      ...
      >
        <nav className="flex flex-col p-8 space-y-6" aria-label="Mobile Navigation">
            ...
            return (
              <a
                ...
                className={`text-lg font-medium border-b pb-2 transition-colors ${
                  isLinkActive
                    ? "text-brand-primary border-blue-100"
          ...
          <a
            href="#contact"
            onClick={(e) => handleNavClick(e, "#contact")}
            className="flex items-center justify-center w-full py-3.5 rounded-xl bg-brand-primary text-white font-semibold text-sm tracking-wide shadow-md shadow-blue-100 hover:bg-brand-primary/95 active:scale-[0.98] transition-all"
          >
            Start a Project
