      ...
      <AnimatePresence>
        {showTop && (
          <motion.button
            ...
            className="fixed bottom-[228px] right-6 z-50 p-3 rounded-full bg-brand-primary text-white shadow-lg shadow-blue-200 hover:bg-brand-primary/90 focus-visible:ring-2 focus-visible:ring-brand-primary"
