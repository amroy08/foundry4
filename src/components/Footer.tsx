  ...
  return (
    <footer className="relative bg-white border-t border-slate-200 pt-20 pb-10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 pb-16 border-b border-slate-100">
          {/* Brand Info */}
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="p-2.5 rounded-full bg-slate-50 border border-slate-200/80 hover:bg-blue-50/50 text-slate-500 hover:text-brand-primary transition-all flex items-center justify-center shadow-sm"
              ...
              {siteConfig.services.map((service) => (
                <li key={service.title}>
                  <a
                    href="#services"
                    onClick={(e) => handleNavClick(e, "#services")}
                    className="text-sm text-slate-600 hover:text-brand-primary transition-colors block truncate max-w-xs"
                  >
                    {service.title}
                  </a>
                </li>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a
                  ...
                  className="text-sm text-slate-600 hover:text-brand-primary transition-colors break-all"
                >
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="text-xs text-slate-500 flex items-center space-x-1.5">
            <span>Built by</span>
            <span className="font-semibold text-slate-900 tracking-wider uppercase bg-slate-50 px-2 py-0.5 rounded text-[10px] border border-slate-200">
              Foundry4
            </span>
            <span>with</span>
