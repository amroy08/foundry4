    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-6 left-6 z-[48] w-[450px] max-w-[calc(100vw-2.5rem)] bg-white/95 border border-slate-200/80 backdrop-blur-md rounded-2xl p-6 shadow-2xl shadow-slate-100 flex flex-col justify-between overflow-hidden group select-none pointer-events-auto"
        >
          {/* Header */}
          ...
          <div className="relative min-h-[96px] flex flex-col justify-center py-1">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="flex items-start space-x-4 cursor-pointer hover:opacity-90 transition-opacity"
                onClick={handleProjectClick}
              >
                {/* Icon Box */}
                <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-100 flex-shrink-0 shadow-sm relative group-hover:scale-105 transition-transform duration-300">
                  {activeProject.icon}
                </div>
                ...
                <div className="flex-1 min-w-0 text-left">
                  <div className="flex items-center space-x-2.5">
                    <h5 className="text-lg font-black text-slate-900 truncate">
                      {activeProject.title}
                    </h5>
                  ...
                  <p className="text-sm md:text-[14px] text-slate-600 leading-relaxed mt-2.5 font-medium">
